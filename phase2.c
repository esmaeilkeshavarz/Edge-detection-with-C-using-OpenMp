...
static float **bytetofloat(png_byte **bytepng)
{
...
double stencilexecution()
{
    ...
    short x,y;
        ...
        #pragma omp parallel for default(none) shared(inputfloatpng,height,width,outputfloatpng) private(x,y) reduction(+:sumpixel) schedule(dynamic) 
...
{   
    ...
    printf("**********************************************\n");
    printf("                                             *\n");
    printf("Phase 2 of Edge detection with a 3*3 Stencil *\n");
    printf("                                             *\n");
    printf("                                             *");
    printf("\n**********************************************\n");
    printf("                                             *\n");
    ...
    float **newpngfloat= stencilledhome(); //--> creating raw Matrix to saving PNG after Filterfloat **inputfloatpng, float **outputfloatpng;
